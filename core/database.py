"""DocuFlow Datenbank — SQLite (thread-safe fuer FastAPI + Watchdog)."""
...
class Database:
    def __init__(self, db_path: str = "./data/docuflow.db"):
        ...
        # FastAPI fuehrt sync-Endpoints im Threadpool aus, und ein optionaler
        # Watchdog-Thread kann parallel scannen. Eine einzige Connection wird
        # daher mit check_same_thread=False geteilt und per RLock serialisiert.
